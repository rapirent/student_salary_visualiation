...
var height = 450, padding = 30, barMargin = 5, axisPadding = 80 , legendPadding = 80;
...
//                    "height": 0,
        ...
        var legend = svg.selectAll(".legend")
                        ...
                        .enter().append("g")
                        .attr("class", "legend")
                        .attr("transform", function(d, i) { return "translate(" + (width - axisPadding) + "," + i * 15 + ")"; });
...
// d3 to visualize
    ...
    // console.log(subjectNumber);
//    console.log("data/data_" + subjectNumber +  ".csv");
    d3.csv("data/data_" + selectNumber +  ".csv", function(error, data){
        if (error){
        console.log(error);
    }
        console.log("data/data_" + subjectNumber +  ".csv");
